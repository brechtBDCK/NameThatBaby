...
- The bundled database combines imported official data (currently France/INSEE) with deterministic fixtures for uncovered countries. Manifest and UI must identify fixture coverage and must not represent the bundle as release-ready.

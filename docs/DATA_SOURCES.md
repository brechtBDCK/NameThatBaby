...
| --- | --- | --- | --- |
| US | [Social Security Administration](https://www.ssa.gov/oact/babynames/limits.html) | Unavailable | `ssa_us` is implemented, but a verified official archive is not bundled. US is not selectable; cache the official archive and rebuild rather than substituting a third-party mirror. |
...
| NL | [Sociale Verzekeringsbank](https://www.svb.nl/nl/kindernamen/namen/vorige-jaren) | Unavailable | A reproducible official export is not bundled. NL is not selectable until the 2015–2024 source can be verified; no fixture substitute is included. |

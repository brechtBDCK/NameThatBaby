...
| Production icon source | `assets/branding/name_that_baby_mark.svg` and generated launcher raster | Review every Android density and iOS size before store release; the mark is an original two-leaf heart in dusty rose, cream, and sage. |
